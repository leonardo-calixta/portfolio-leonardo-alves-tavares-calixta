...
🧪 Casos de Teste
TesteDescriçãoResultadoTeste 1Orçamento total sem filtrosUSD 209.000,00Teste 2Ignorando Cultura e DesenvolvimentoSoma sem esses departamentosTeste 3Conversão para BRL (taxa 5,20)BRL 1.086.800,00
...
Abra o arquivo sistema_de_auditoria_de_recursos_corporativos.py.
Execute — os 3 testes rodam automaticamente e exibem o log completo de auditoria para cada cenário.
