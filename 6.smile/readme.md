...
| Nível | Iteração | Ação |
|-------|----------|------|
| **Nível 1** | Dicionário (`emoji_data`) | Localiza a chave `"grade"` |
| **Nível 2** | Linhas da grade | Percorre cada linha do emoji |
| **Nível 3** | Pixels da linha | Aplica o filtro em cada pixel |
...
2. Certifique-se de ter o `matplotlib` instalado: `pip install matplotlib`.
3. Abra o arquivo `smile.py` e execute — o emoji sombreado será exibido como imagem.
