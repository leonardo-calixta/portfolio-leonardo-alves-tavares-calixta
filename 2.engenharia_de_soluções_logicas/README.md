...
|--------|----------|------|
| **D1 — Rede congestionada?** | `Total_Rede > 80 carros` | Entra em Modo Ajuste e identifica cruzamento crítico |
| **D2 — Emergência?** | `Crítico > 50 carros` | Ativa Modo Crise e aciona agente de trânsito |
| **D3 — Onda verde possível?** | `Crítico ≤ 40 carros` | Sincroniza fases (A, B, C, D) com +8s no cruzamento crítico |
