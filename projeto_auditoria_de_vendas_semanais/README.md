...
Abra o arquivo projeto_auditoria_de_vendas_semanais.py.
Execute o script e insira os três valores de venda quando solicitado.
O sistema exibirá a média calculada e o status da auditoria.
