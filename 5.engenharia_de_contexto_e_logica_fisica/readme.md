...
| Local | Horário | Temp | Umidade | IQA | Qualidade do Ar |
|-------|---------|------|---------|-----|-----------------|
| São Paulo | 15h | 27°C | 57% | 61 | Moderada |
| São Paulo | 18h | 22°C | 45% | 61 | Moderada |
| Santos | 15h | 26°C | 54% | 67 | Moderada |
| Santos | 18h | 24°C | 58% | 68 | Moderada |
| Campinas | 15h | 27°C | 42% | 81 | Ruim |
| Campinas | 18h | 23°C | 53% | 84 | Ruim |
...
2. Abra o arquivo `engenharia_de_contexto_e_logica_fisica.py`.
3. Execute — a Parte 1 roda automaticamente com dados embutidos; a Parte 2 simula o trajeto de evacuação.
